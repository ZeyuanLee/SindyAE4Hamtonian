...
# ╔═╡ 9a464750-2b15-11f0-2e0a-37fc3fd13dda
using LinearAlgebra

# ╔═╡ ad10e860-f1cf-4c01-a44c-e08dae8dc1bf
using Plots

# ╔═╡ b49fb158-5434-49bd-9731-73701d2db71f
using ForwardDiff

# ╔═╡ b1a5b9c9-017d-4bd3-9ee2-b2ff054bb98d
const q=1.0

# ╔═╡ 9f7b2278-3955-4583-ab63-2a3e66aa1681
const m=1.0

# ╔═╡ e13820e2-7356-414a-962d-6ef9c762d66a
const E=[1.0, 0.0, 0.0]

# ╔═╡ 19433b6b-58c4-492e-9242-31e1fd87d35e
const B=[0.0, 0.0, -2.0]

# ╔═╡ 4f7d9420-591d-4b0d-97cc-28fc6ab04e2a
function lorentz_force(v)
	return q*(E+cross(v, B))
end

# ╔═╡ ce8d0a58-409e-4b09-881f-386873fdd554
...
# ╔═╡ 9bc41004-6029-4f4c-89c4-5b890d6769bc
...
# ╔═╡ ad5b2969-66bd-4aa1-9c3e-5cdad308676c
main()
...
manifest_format = "2.0"
project_hash = "50fc94081d5b8af4c1dfa62801d5eeb2554b3809"
